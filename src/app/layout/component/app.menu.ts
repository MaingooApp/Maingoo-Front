    ...
    this.model = [
      {
        ...
        items: [
          ...
          {
            label: this.translate.instant('menu.documentation'),
            icon: 'pi pi-fw pi-file',
            routerLink: ['/docgenerator']
          },
      ...
      },
      {
        ...
        items: [
          {
            label: this.translate.instant('menu.form_layout'),
            icon: 'pi pi-fw pi-id-card',
            routerLink: ['/uikit/formlayout']
          },
          {
            label: this.translate.instant('menu.input'),
            icon: 'pi pi-fw pi-check-square',
            routerLink: ['/uikit/input']
          },
          {
            label: this.translate.instant('menu.button'),
          ...
          {
            label: this.translate.instant('menu.timeline'),
