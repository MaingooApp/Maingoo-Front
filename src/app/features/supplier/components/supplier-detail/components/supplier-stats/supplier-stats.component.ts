  ...
  initChartOptions() {
    this.chartOptions = {
      ...
      plugins: {
        ...
        tooltip: {
          backgroundColor: this.getCssVariable('--p-surface-900', '#111827'),
          titleColor: this.getCssVariable('--p-surface-0', '#ffffff'),
          bodyColor: this.getCssVariable('--p-surface-0', '#ffffff'),
          cornerRadius: 4,
          displayColors: false,
          callbacks: {
      ...
      scales: {
        x: {
          ...
          ticks: {
            color: this.getCssVariable('--p-surface-500', '#6b7280'),
            font: { size: 10 }
          }
        },
        y: {
        ...
        datasets: [
          {
            label: 'Gasto Anual',
            data: yearlyTotals,
            backgroundColor: this.getCssVariable('--p-primary-color', '#10b981'),
            hoverBackgroundColor: this.getCssVariable('--p-primary-hover-color', '#059669'),
            borderRadius: 4,
            barThickness: 20
          }
        ]
